...
class GltfModel
{
    ...
    async init() {
        ...
        if(this.gltfData.nodes !== undefined){
            ...
            this.inst.Trigger(globalThis.C3.Plugins.Mikal_3DObject.Cnds.onLoadFailed);
        }
    ...
    */
    ...
    getPolygons()
    {
        ...
        if(gltf.scene !== "undefined" && gltf.scene.nodes !== "undefined"){
